                ...
                ForEach(colors, id: \.self) { color in
                    ZStack{
                        ...
                        Text("Rear Lug Nuts")
                            ...
                            NavigationLink(destination:RearAxleSeal()){
                                        Text("Next")
                                            .padding()
                                            .font(.title)
                                            .background(.orange)
...
struct RearLugNuts_Previews: PreviewProvider {
