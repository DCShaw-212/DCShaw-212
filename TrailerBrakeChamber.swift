...
struct TrailerBrakeChamber: View {
                ...
                ForEach(colors, id: \.self) { color in
                    ZStack{
                        ...
                        Text("Trailer")
                            ...
                            NavigationLink(destination:TrailerSlackAndPush()){
                                        Text("Next")
                                            .padding()
                                            .font(.title)
                                            .background(.orange)
...
struct TrailerBrakeChamber_Previews: PreviewProvider {
